...
- [ ] Перевести граф расследования с `entity -> entity` BFS на полноценный evidence-graph: `Person -> VoteSession -> Bill`, `Organization -> Contract -> Agency`, `Claim -> SourceItem -> Entity`
